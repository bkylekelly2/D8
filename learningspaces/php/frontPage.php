...
<div class="container-fluid" id="main-content">
      ...
      <div class="row">
		...
		<form name="spacesForm" id="spacesForm" >
		...
		<div ng-repeat="room in rooms track by $index" ng-cloak>
			...
			<div class="roomTeaser" data-room-id="{{room.roomID}}"  data-id="{{room.roomID}}" tabindex="0" ng-mouseenter="teaserMouseEnter(room.roomID,true)" ng-focus="teaserMouseEnter(room.roomID)" onmouseleave="angular.element(this).scope().teaserMouseLeave()" onblur="angular.element(this).scope().teaserMouseLeave()">
		...
		<h2>Filter the spaces</h2>
			<div class="filter_division union" id="space_types">
				...
				?>
					<li>
					<input type="checkbox" ng-model="spaceType.<?php echo $ngtitle; ?>" name="name_spaceType" value="<?php echo $nid; ?>" id="<?php echo $nid; ?>" ng-change="submit();" class="checkbox <?php echo $ngtitle; ?>" >
			...
			<div class="filter_division union" id="noise_expectations">
				...
				?>
					<li>
					<input type="checkbox" ng-model="noiseExpectation.<?php echo $ngtitle; ?>" name="name_noiseExpectation" value="<?php echo $nid; ?>" id="<?php echo $nid; ?>" ng-change="submit();" class="checkbox <?php echo $ngtitle; ?>">
					<label for="<?php echo $nid; ?>">
					<?php echo $title; ?>
					</label>
					<div id="<?php echo $ngtitle; ?>"></div>
			...
			<div class="filter_division intersection" id="amenities">
				...
				?>
					<li>
					<input type="checkbox" ng-model="amenity.<?php echo $ngtitle; ?>" name="name_amenity" value="<?php echo $nid; ?>" id="<?php echo $nid; ?>" ng-change="submit();" class="checkbox <?php echo $ngtitle; ?>">
					<label for="<?php echo $nid; ?>">
			...
			<div class="filter_division intersection" id="technology">
				...
				?>
					...
					<li>
					<input type="checkbox" ng-model="technology.<?php echo $ngtitle; ?>" name="name_technology" value="<?php echo $nid; ?>" id="<?php echo $nid; ?>" ng-change="submit();" class="checkbox <?php echo $ngtitle; ?>">
					<label for="<?php echo $nid; ?>">
			...
			<div class="filter_division collapsed intersection" id="furniture">
				...
				?>
					<li>
					<input type="checkbox" ng-model="furniture.<?php echo $ngtitle; ?>" name="name_furniture" value="<?php echo $nid; ?>" id="<?php echo $nid; ?>" ng-change="submit();" class="checkbox <?php echo $ngtitle; ?>">
					<label for="<?php echo $nid; ?>">
			...
			<div class="filter_division collapsed union" id="building"  >
				...
				<li ng-repeat="bF in buildingFilter track by $index">
					<input type="checkbox" ng-model="building[bF.filter]" name="name_building" value="{{bF.buildingID}}" id="{{bF.buildingID}}" ng-click="submit()" class="checkbox {{bF.filter}}">
