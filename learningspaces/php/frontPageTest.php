...
<head>
  ...
  <script src="/modules/learningspaces/js/learningspaces-angularTest.js"></script>
		...
		<div id="header-wrapper">
			<div class="gwlogo">
				<a href="/" title="<?php echo $siteTitle; ?>" target="_self">
					<img typeof="foaf:Image" src="/modules/learningspaces/images/study-spaces-logo-02.png" alt="GW <?php echo $siteTitle; ?> logo" height="90">
				</a>
	...
	<form name="spacesForm" >
		...
		<ul id="triggers">
			...
			<div class="filter_division" id="campus">
				...
				<ul>
					<li>
					<input type="radio" ng-model="campus" name="name_campus" value="433" ng-click="submit_reset()" id="foggy-bottom">
					<label for="foggy-bottom">
					Foggy Bottom
					</label>
					</li>
					<li>
					<input type="radio" ng-model="campus" name="name_campus" value="434" ng-click="submit_reset()" id="mt-vernon">
					<label for="mt-vernon">
					Mount Vernon
					</label>
					</li>
			...
			<div id="results_count">
				<div>Showing {{showing}} of {{total}} results</div>
				<div id="load" ng-click="loadMoreResults();" style="background-color:#ededed;">{{loadMore}}</div>
			</div>
		...
		<h2>Filter the spaces</h2>
			<div class="filter_division union" id="space_types">
				...
				?>
					<li>
					<input type="checkbox" ng-model="spaceType.<?php echo $ngtitle; ?>" name="name_spaceType" value="<?php echo $nid; ?>" id="<?php echo $nid; ?>" ng-click="submit();">
			...
			<div class="filter_division union" id="noise_expectations">
				...
				?>
					<li>
					<input type="checkbox" ng-model="noiseExpectation.<?php echo $ngtitle; ?>" name="name_noiseExpectation" value="<?php echo $nid; ?>" id="<?php echo $nid; ?>" ng-click="submit();">
					<label for="<?php echo $nid; ?>">
					<?php echo $title; ?>
					</label>
					</li>
			...
			<div class="filter_division intersection" id="amenities">
				...
				?>
					<li>
					<input type="checkbox" ng-model="amenity.<?php echo $ngtitle; ?>" name="name_amenity" value="<?php echo $nid; ?>" id="<?php echo $nid; ?>" ng-click="submit();">
					<label for="<?php echo $nid; ?>">
			...
			<div class="filter_division intersection" id="technology">
				...
				?>
					...
					<li>
					<input type="checkbox" ng-model="technology.<?php echo $ngtitle; ?>" name="name_technology" value="<?php echo $nid; ?>" id="<?php echo $nid; ?>" ng-click="submit();">
					<label for="<?php echo $nid; ?>">
					<?php echo $title; ?>
					</label>
					</li>
			...
			<div class="filter_division collapsed intersection" id="furniture">
				...
				?>
					<li>
					<input type="checkbox" ng-model="furniture.<?php echo $ngtitle; ?>" name="name_furniture" value="<?php echo $nid; ?>" id="<?php echo $nid; ?>" ng-click="submit();">
					<label for="<?php echo $nid; ?>">
					<?php echo $title; ?>
					</label>
					</li>
