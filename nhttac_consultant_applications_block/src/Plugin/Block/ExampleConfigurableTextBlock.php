...
class ExampleConfigurableTextBlock extends BlockBase {
  ...
  public function defaultConfiguration() {
    return [
      'nhttac_consultant_applications_block_string' => $this->t('A default value. This block was created at %time', ['%time' => date('c')]),
    ];
  }
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    $form['nhttac_consultant_applications_block_string_text'] = [
      '#type' => 'textarea',
      '#title' => $this->t('Block contents'),
      '#description' => $this->t('This text will appear in the example block.'),
      '#default_value' => $this->configuration['nhttac_consultant_applications_block_string'],
    ];
    return $form;
  }
  ...
  public function blockSubmit($form, FormStateInterface $form_state) {
    $this->configuration['nhttac_consultant_applications_block_string']
      = $form_state->getValue('nhttac_consultant_applications_block_string_text');
  }
  ...
  public function build() {
    return [
      '#markup' => $this->configuration['nhttac_consultant_applications_block_string'],
    ];
  }
